...
public class MessageModalAdapter extends RecyclerView.Adapter<MessageModalAdapter.ChatViewHolder> implements Handler.Callback {
    ...
    private ChatBoardActivity_old activity;
    /*type
    1 text
    2 image
    3 image+text
    ...
    public MessageModalAdapter(Context mContext, ChatBoardActivity_old activity, ArrayList<MessageModal> chatList) {
