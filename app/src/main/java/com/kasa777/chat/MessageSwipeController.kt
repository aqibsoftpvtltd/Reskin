...
import com.kasa777.chat.AndroidUtils
...
class MessageSwipeController(private val context: Context, private val swipeControllerActions: SwipeControllerActions) :
    ...
    override fun getMovementFlags(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder): Int {
        ...
        imageDrawable = context.resources.getDrawable(R.drawable.ic_reply_black_24dp)!!
        shareRound = context.resources.getDrawable(R.drawable.ic_round_shape)!!
