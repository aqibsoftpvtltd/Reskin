...
public class StarlineResultAdapter extends RecyclerView.Adapter<StarlineResultAdapter.ViewHolder> {
    ...
    private List<com.kasa777.modal.history_data_modal.starlineresulthistory.Datum> fundData;
    private View.OnClickListener onClickListener;

    public StarlineResultAdapter(Context mContext, List<com.kasa777.modal.history_data_modal.starlineresulthistory.Datum> fundData ) {
    ...
    public void onBindViewHolder(@NonNull StarlineResultAdapter.ViewHolder holder, int position) {
        com.kasa777.modal.history_data_modal.starlineresulthistory.Datum datum = fundData.get(position);
