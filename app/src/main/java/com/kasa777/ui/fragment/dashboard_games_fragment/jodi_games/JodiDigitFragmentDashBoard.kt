...
class JodiDigitFragmentDashBoard : Fragment(), View.OnClickListener {


    private val myList = arrayListOf<String>()

    private var jodiDigitsPannaArray = arrayOf(
        "00",
        "01",
        "02",
        "03",
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tvFinalSubmit!!.setOnClickListener {
            if (bidItems!!.size > 0) {
                dialogBitSubmit(GameTypeNames.JodiDigit)
            } else {
    ...
    private fun generateBid(stDigits: String, stPoints: String) {
        val bidItem = BidData(
            stDigits,
            stPoints,
            gameTypeName,
