...
import com.kasa777.adapter.bids_history_adapter.*
import com.kasa777.adapter.history_adapter_pagination.BidHistoryPaginationAdapter
import com.kasa777.constant.Constant
import com.kasa777.modal.filterdata.RequestBodyFilter
...
import com.kasa777.modal.history_pagination.BidHistory
import com.kasa777.modal.history_pagination.RecordsItem
import com.kasa777.retrofit_provider.AuthHeaderRetrofitService
import com.kasa777.retrofit_provider.WebResponse
import com.kasa777.ui.fragment.FilterBottomSheetFragment
...
class BidsHistoryActivity : BaseActivity(), View.OnClickListener,
    ...
    private var andarBaharList: ArrayList<com.kasa777.modal.history_data_modal.jackpotresulthistory.Datum> =
        ArrayList()
    private var starLineResultList: ArrayList<com.kasa777.modal.history_data_modal.starlineresulthistory.Datum> =
        ArrayList()
    ...
    private fun init() {
        ...
        when (strFrom) {
            ...
            "fundRequestHistory" -> {
                ...
                val recordlist: List<com.kasa777.modal.fund_pagination.RecordsItem> =
                    ArrayList()
