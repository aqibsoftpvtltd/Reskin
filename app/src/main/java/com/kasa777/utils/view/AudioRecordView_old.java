package com.kasa777.utils.view;
...
public class AudioRecordView_old {
    ...
    public void initView(ViewGroup view) {
        ...
        view.removeAllViews();
        view.addView(LayoutInflater.from(view.getContext()).inflate(R.layout.layout_record_view_old_one, null));
        ...
        imageQuote = view.findViewById(R.id.imageQuote);
        txtQuotedMsg = view.findViewById(R.id.txtQuotedMsg);
        txtQuotedUsername = view.findViewById(R.id.txtQuotedUsername);
...
//    }
    ...
    public void setAudioRecordButtonImage(int imageResource) {
        imageViewAudio.setImageResource(imageResource);
    }

    public void setStopButtonImage(int imageResource) {
        imageViewStop.setImageResource(imageResource);
    }

    public void setSendButtonImage(int imageResource) {
        imageViewSend.setImageResource(imageResource);
    }
