package com.kasa777.modal.jackpot_modal.gametype_id;
...
public class GameTypeIdList implements Parcelable
{
    ...
    protected GameTypeIdList(Parcel in) {
        ...
        in.readList(this.gameTypes, (com.kasa777.modal.jackpot_modal.gametype_id.GameType.class.getClassLoader()));
    }
