...
this.gameWinPoints = ((Double) in.readValue((Integer.class.getClassLoader())));
...
public Double getGameWinPoints() {
return gameWinPoints;
}

public void setGameWinPoints(Double gameWinPoints) {
