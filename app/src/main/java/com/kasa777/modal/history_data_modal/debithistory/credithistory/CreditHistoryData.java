package com.kasa777.modal.history_data_modal.debithistory.credithistory;
...
public class CreditHistoryData implements Parcelable
{
    ...
    protected CreditHistoryData(Parcel in) {
        ...
        in.readList(this.data, (com.kasa777.modal.history_data_modal.debithistory.credithistory.Datum.class.getClassLoader()));
    }
