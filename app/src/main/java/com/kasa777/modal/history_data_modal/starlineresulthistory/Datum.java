package com.kasa777.modal.history_data_modal.starlineresulthistory;
...
@SerializedName("winningDigitFamily")
@Expose
private Integer winningDigitFamily;
...
;
    ...
    public Integer getWinningDigitFamily() {
        return winningDigitFamily;
    }

    public void setWinningDigitFamily(Integer winningDigitFamily) {
        this.winningDigitFamily = winningDigitFamily;
    }
...
this.winningDigitFamily = ((Integer) in.readValue((Integer.class.getClassLoader())));
...
dest.writeValue(winningDigitFamily);
