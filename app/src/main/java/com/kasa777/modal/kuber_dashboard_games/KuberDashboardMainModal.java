...
public class KuberDashboardMainModal implements Parcelable
{
    ...
    protected KuberDashboardMainModal(Parcel in) {
        ...
        in.readList(this.provider, (com.kasa777.modal.kuber_dashboard_games.Provider.class.getClassLoader()));
        in.readList(this.openCloseTime, (com.kasa777.modal.kuber_dashboard_games.OpenCloseTime.class.getClassLoader()));
    }
