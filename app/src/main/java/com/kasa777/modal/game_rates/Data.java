...
in.readList(this.gameRates, (com.kasa777.modal.game_rates.GameRate.class.getClassLoader()));
in.readList(this.starGameRates, (com.kasa777.modal.game_rates.StarGameRate.class.getClassLoader()));
in.readList(this.aBgameRates, (com.kasa777.modal.game_rates.ABgameRate.class.getClassLoader()));
}
