...
public class AndarBaharHistoryAdapter extends RecyclerView.Adapter<AndarBaharHistoryAdapter.ViewHolder> {
    ...
    private List<com.kasa77.modal.history_data_modal.jackpotresulthistory.Datum> fundData;
    private View.OnClickListener onClickListener;

    public AndarBaharHistoryAdapter(Context mContext, List<com.kasa77.modal.history_data_modal.jackpotresulthistory.Datum> fundData ) {
    ...
    public void onBindViewHolder(@NonNull AndarBaharHistoryAdapter.ViewHolder holder, int position) {
        com.kasa77.modal.history_data_modal.jackpotresulthistory.Datum datum = fundData.get(position);
