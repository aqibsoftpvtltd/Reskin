...
public class BidJackpotItemAdapter extends RecyclerView.Adapter<BidJackpotItemAdapter.ViewHolder> {
    private Context mContext;
    private List<BidItemModel> bidItems;
    private View.OnClickListener onClickListener;

    public BidJackpotItemAdapter(Context mContext, List<BidItemModel> bidItem, View.OnClickListener onClickListener) {
    ...
    @NonNull
    @Override
    public BidJackpotItemAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BidJackpotItemAdapter.ViewHolder holder, int position) {
