package com.kasa77.modal.history_data_modal.jackpotbidhistory;
...
public class JackpotHistoryData implements Parcelable
{
    ...
    protected JackpotHistoryData(Parcel in) {
        ...
        in.readList(this.data, (com.kasa77.modal.history_data_modal.jackpotbidhistory.Datum.class.getClassLoader()));
    }
