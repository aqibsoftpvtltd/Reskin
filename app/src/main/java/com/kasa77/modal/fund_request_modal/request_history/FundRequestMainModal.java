package com.kasa77.modal.fund_request_modal.request_history;
...
public class FundRequestMainModal implements Parcelable
{
    ...
    protected FundRequestMainModal(Parcel in) {
        ...
        in.readList(this.data, (com.kasa77.modal.fund_request_modal.request_history.Datum.class.getClassLoader()));
    }
