...
import com.kasa77.interfaces.FragmentCallBack;
import com.kasa77.modal.dashboard_gamelist.Result;
import com.kasa77.modal.history_data_modal.starlineresulthistory.Datum;
...
//                    }
    ...
    public List<com.kasa77.ui.fragment.startline_game_fragment.modal.Result> getSortedListStarline(List<com.kasa77.ui.fragment.startline_game_fragment.modal.Result> arrayList) {
        Collections.sort(arrayList, new Comparator<com.kasa77.ui.fragment.startline_game_fragment.modal.Result>() {
            @Override
            public int compare(com.kasa77.ui.fragment.startline_game_fragment.modal.Result o1, com.kasa77.ui.fragment.startline_game_fragment.modal.Result o2) {
                try {
                    SimpleDateFormat dateFormat = new SimpleDateFormat("hh:mm a");
    ...
    public List<com.kasa77.ui.fragment.jackpot_fragments.modal.Result> getSortedListJackpot(List<com.kasa77.ui.fragment.jackpot_fragments.modal.Result> arrayList) {
        Collections.sort(arrayList, new Comparator<com.kasa77.ui.fragment.jackpot_fragments.modal.Result>() {
            @Override
            public int compare(com.kasa77.ui.fragment.jackpot_fragments.modal.Result o1, com.kasa77.ui.fragment.jackpot_fragments.modal.Result o2) {
                try {
                    SimpleDateFormat dateFormat = new SimpleDateFormat("hh:mm a");
                    return dateFormat.parse(o1.openBidTime).compareTo(dateFormat.parse(o2.openBidTime));
                } catch (ParseException e) {
    ...
    public List<com.kasa77.modal.history_data_modal.jackpotresulthistory.Datum> getSortedListJackpotResult(List<com.kasa77.modal.history_data_modal.jackpotresulthistory.Datum> arrayList) {
        Collections.sort(arrayList, new Comparator<com.kasa77.modal.history_data_modal.jackpotresulthistory.Datum>() {
            @Override
            public int compare(com.kasa77.modal.history_data_modal.jackpotresulthistory.Datum o1, com.kasa77.modal.history_data_modal.jackpotresulthistory.Datum o2) {
                try {
                    SimpleDateFormat dateFormat = new SimpleDateFormat("hh:mm a");
                    return dateFormat.parse(o1.getProviderName()).compareTo(dateFormat.parse(o2.getProviderName()));
                } catch (ParseException e) {
